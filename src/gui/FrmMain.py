...
[wxID_FRMMAIN, wxID_FRMMAINBITMAPLEFT, wxID_FRMMAINBITMAPRIGHT, 
 ...
 wxID_FRMMAINPNLEDITPICTURE, wxID_FRMMAINTOOLBARIMGSECT, 
] = [wx.NewId() for _init_ctrls in range(11)]


[wxID_FRMMAINTOOLBARIMGSECTTOOLAUTOPATH, 
 wxID_FRMMAINTOOLBARIMGSECTTOOLFROMNEXT, 
 wxID_FRMMAINTOOLBARIMGSECTTOOLFROMPREV, 
 wxID_FRMMAINTOOLBARIMGSECTTOOLLEFTTORIGHT, 
 wxID_FRMMAINTOOLBARIMGSECTTOOLRIGHTTOLEFT, 
...
class FrmMain(wx.Frame, Observer, UserInteractionHandler):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.toolBarImgSect = wx.ToolBar(id=wxID_FRMMAINTOOLBARIMGSECT,
    ...
    def OnToolBarImgSectToolFromPrev(self, event):
        selItem = self.listView.GetSelected()
        selPic = self.listView.GetPicture(selItem)
        prevPic = self.listView.GetPicture(selItem - 1)
    ...
    def OnToolBarImgSectToolFromNext(self, event):
        selItem = self.listView.GetSelected()
        selPic = self.listView.GetPicture(selItem)
        nextPic = self.listView.GetPicture(selItem + 1)
